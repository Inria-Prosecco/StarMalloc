...
val get_left (#a: Type) (n: node a) : t a
val get_right (#a: Type) (n: node a) : t a
val get_data (#a: Type) (n: node a) : a
val get_size (#a: Type) (n: node a) : nat

val mk_node (#a: Type) (data: a) (left right: t a) (size: nat)
    : Pure (node a)
      (requires True)
      (ensures (fun n ->
        get_left n == left /\
...
val size_of_tree (#a: Type0) (t: Spec.tree a)
  : Tot nat
...
val pack_tree (#a: Type0) (ptr: t a) (left: t a) (right: t a) (s:nat)
    //(s:nat)
    : Steel unit
      ...
      (requires (fun h0 ->
        ...
        get_size (sel ptr h0) == s /\
        s == size_of_tree (v_linked_tree left h0) + size_of_tree (v_linked_tree right h0) + 1))
      (ensures (fun h0 _ h1 ->
        v_linked_tree ptr h1 ==
          Spec.Node (get_data (sel ptr h0)) (v_linked_tree left h0) (v_linked_tree right h0) s
      ))
