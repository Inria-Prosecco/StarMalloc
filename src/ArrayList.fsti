...
unfold
let varraylist (pred1 pred2 pred3 pred4: status -> prop) (r:A.array cell) (hd1 hd2 hd3 hd4:nat) : vprop =
  AL.varraylist pred1 pred2 pred3 pred4 r hd1 hd2 hd3 hd4

[@@ __steel_reduce__]
let v_arraylist (#p2:vprop) (pred1 pred2 pred3 pred4: status -> prop) (r:A.array cell) (hd1 hd2 hd3 hd4:nat)
  (h:rmem p2{FStar.Tactics.with_tactic selector_tactic
    (can_be_split p2 (varraylist pred1 pred2 pred3 pred4 r hd1 hd2 hd3 hd4) /\ True)}) : GTot (Seq.seq cell)
  = h (varraylist pred1 pred2 pred3 pred4 r hd1 hd2 hd3 hd4)
...
val read_in_place
  ...
  : Steel status
          ...
          (ensures fun h0 result h1 ->
            let gs0 = v_arraylist pred1 pred2 pred3 pred4 r hd1 hd2 hd3 hd4 h0 in
...
val remove1
  ...
  (idx:US.t{US.v idx < A.length r})
   : Steel US.t
          ...
          (requires fun h ->
            AL.mem (US.v idx) (US.v hd1) (h (varraylist pred1 pred2 pred3 pred4 r (US.v hd1) hd2 hd3 hd4)))
...
val remove2
  ...
  (idx:US.t{US.v idx < A.length r})
   : Steel US.t
          ...
          (requires fun h ->
            AL.mem (US.v idx) (US.v hd2) (h (varraylist pred1 pred2 pred3 pred4 r hd1 (US.v hd2) hd3 hd4)))
          (ensures fun h0 hd' h1 ->
...
val remove3
  ...
  (idx:US.t{US.v idx < A.length r})
   : Steel US.t
          ...
          (requires fun h ->
            AL.mem (US.v idx) (US.v hd3) (h (varraylist pred1 pred2 pred3 pred4 r hd1 hd2 (US.v hd3) hd4)))
          (ensures fun h0 hd' h1 ->
