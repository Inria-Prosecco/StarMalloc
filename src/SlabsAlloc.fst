...
let allocate_slab_aux_1_partial
  ...
  (
    ...
    starseq
      ...
      #(t size_class)
      (f size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idx1) 1ul))
      (f_lemma size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idx1) 1ul))
  ...
  (fun _ ->
    vrefinedep
      (vptr md_count)
      vrefinedep_prop
      (left_vprop size_class slab_region md_bm_region md_bm_region_q md_region r_idxs)
  )
  (requires fun h0 ->
  ...
  (**) pack_3 size_class slab_region md_bm_region md_bm_region_q md_region md_count r_idxs
...
let allocate_slab_aux_1_full
  ...
  (
    ...
    starseq
      #(pos:US.t{US.v pos < US.v md_count_v})
      #(t size_class)
      (f size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idx1) 2ul))
      (f_lemma size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idx1) 2ul))
      (SeqUtils.init_us_refined (US.v md_count_v))
  )
  (fun _ ->
    vrefinedep
...
let allocate_slab_aux_1
  ...
  (
    ...
    starseq
      #(pos:US.t{US.v pos < US.v md_count_v})
      #(t size_class)
      (f size_class slab_region md_bm_region md_bm_region_q md_count_v md_region_lv)
      (f_lemma size_class slab_region md_bm_region md_bm_region_q md_count_v md_region_lv)
      (SeqUtils.init_us_refined (US.v md_count_v))
  )
  (fun r ->
    A.varray r `star`
  ...
  (**) change_equal_slprop
    (f size_class slab_region md_bm_region md_bm_region_q md_count_v md_region_lv (Seq.index (SeqUtils.init_us_refined (US.v md_count_v)) (US.v idx1)))
    (p_empty size_class
       (slab_array slab_region idx1)
       (md_bm_array md_bm_region idx1)
       (md_bm_array md_bm_region_q idx1));
...
let allocate_slab_aux_2_full
  ...
  (
    ...
    starseq
      #(pos:US.t{US.v pos < US.v md_count_v})
      #(t size_class)
      (f size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idx2) 2ul))
      (f_lemma size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idx2) 2ul))
      (SeqUtils.init_us_refined (US.v md_count_v))
  )
  (fun _ ->
    vrefinedep
...
let allocate_slab_aux_2_partial
  ...
  (
    ...
    starseq
      #(pos:US.t{US.v pos < US.v md_count_v})
      #(t size_class)
      (f size_class slab_region md_bm_region md_bm_region_q md_count_v (G.reveal md_region_lv))
      (f_lemma size_class slab_region md_bm_region md_bm_region_q md_count_v (G.reveal md_region_lv))
      (SeqUtils.init_us_refined (US.v md_count_v))
  )
  (fun _ ->
    vrefinedep
...
let allocate_slab_aux_2_aux
  ...
  (
    slab_vprop size_class
      ...
      (md_bm_array md_bm_region_q idx2) `star`
    (vptr md_count `star`
    A.varray r_idxs `star`
    (AL.varraylist pred1 pred2 pred3 pred4 pred5
      (A.split_l md_region md_count_v)
  ...
  (requires fun h0 ->
    ...
    let blob0
      : t_of (slab_vprop size_class
        (slab_array slab_region idx2)
        (md_bm_array md_bm_region idx2)
        (md_bm_array md_bm_region_q idx2))
      = h0 (slab_vprop size_class
        (slab_array slab_region idx2)
        (md_bm_array md_bm_region idx2)
        (md_bm_array md_bm_region_q idx2)) in
    let mds : _ & Seq.lseq U64.t 4 = dfst (fst blob0) in
    not (is_empty size_class (seq_u64_or (fst mds) (snd mds))) /\
    US.v md_count_v <> AL.null /\
    sel md_count h0 == md_count_v /\
    Seq.index idxs0 0 == idx1 /\
    Seq.index idxs0 1 == idx2 /\
  ...
  if cond then (
    ...
    (**) starseq_weakening
      ...
      #(pos:US.t{US.v pos < US.v md_count_v})
      #(t size_class)
      (f size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idx2) 1ul))
      (f size_class slab_region md_bm_region md_bm_region_q md_count_v md_region_lv)
      (f_lemma size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idx2) 1ul))
      (f_lemma size_class slab_region md_bm_region md_bm_region_q md_count_v md_region_lv)
      (SeqUtils.init_us_refined (US.v md_count_v))
      (SeqUtils.init_us_refined (US.v md_count_v));
...
let allocate_slab_aux_2
  ...
  (**) change_equal_slprop
     (f size_class slab_region md_bm_region md_bm_region_q md_count_v md_region_lv (Seq.index (SeqUtils.init_us_refined (US.v md_count_v)) (US.v idx2)))
     (p_partial size_class
       (slab_array slab_region idx2)
       (md_bm_array md_bm_region idx2)
       (md_bm_array md_bm_region_q idx2));
  ...
  let r = allocate_slot size_class
    ...
    (md_bm_array md_bm_region_q idx2)
  in
  allocate_slab_aux_2_aux size_class
    slab_region md_bm_region md_bm_region_q md_region md_count r_idxs
...
let alloc_metadata_sl1
  ...
  (requires
    SM.interp (hp_of
      ...
      A.varray (A.split_r md_bm_region_q (US.mul (G.reveal md_count_v) 4sz)) `star`
  ...
  (ensures
    SM.interp (hp_of
      ...
      A.varray (A.split_r md_bm_region_q (US.mul md_count_v0 4sz)) `star`
...
let alloc_metadata_sl2
  ...
  (requires
    SM.interp (hp_of
      ...
      A.varray (A.split_r md_bm_region_q (US.mul (US.add md_count_v0 1sz) 4sz)) `star`
  ...
  (ensures
    SM.interp (hp_of
      ...
      A.varray (A.split_r md_bm_region_q (US.mul (US.add (G.reveal md_count_v) 1sz) 4sz)) `star`
...
let right_vprop_sl_lemma1
  ...
  (requires SM.interp (hp_of (
    right_vprop slab_region md_bm_region md_bm_region_q md_region v
  )) m)
  (ensures SM.interp (hp_of (
    ...
    (A.varray (A.split_r md_bm_region (US.mul v 4sz))
      `vrefine` zf_u64) `star`
    (A.varray (A.split_r md_bm_region_q (US.mul v 4sz))
      `vrefine` zf_u64) `star`
  ...
  ==
  sel_of (right_vprop slab_region md_bm_region md_bm_region_q md_region v) m
  )
  = ()
...
let allocate_slab_aux_3_1_right_aux
  ...
  (
    ...
    A.varray (A.split_r md_bm_region_q (US.mul md_count_v 4sz)) `star`
  ...
  (fun _ ->
    ...
    (A.varray (A.split_r md_bm_region_q
      (US.mul (US.add md_count_v guard_pages_interval) 4sz)) `vrefine` zf_u64) `star`
  ...
  (requires fun h0 ->
    ...
    zf_u64 (A.asel
      (A.split_r md_bm_region_q (US.mul md_count_v 4sz))
      h0
    )
  )
  (ensures fun _ _ h1 ->
  ...
  let md_bm_region_q0 = gget (A.varray (A.split_r md_bm_region_q (US.mul md_count_v 4sz))) in
  zf_u8_split slab_region0 (US.v guard_pages_interval * U32.v page_size);
  zf_u64_split md_bm_region0 (US.v guard_pages_interval * 4);
  zf_u64_split md_bm_region_q0 (US.v guard_pages_interval * 4);
  A.ghost_split
    (A.split_r slab_region (US.mul md_count_v (u32_to_sz page_size)))
...
let allocate_slab_aux_3_1_right
  ...
  : SteelGhost unit opened
  (
    right_vprop slab_region md_bm_region md_bm_region_q md_region md_count_v
  )
  (fun _ ->
    right_vprop slab_region md_bm_region md_bm_region_q md_region (md_count_v `US.add` guard_pages_interval) `star`
    A.varray (A.split_l
      (A.split_r slab_region
        (US.mul md_count_v (u32_to_sz page_size)))
        (US.mul guard_pages_interval (u32_to_sz page_size))) `star`
  ...
  change_slprop_rel
    ...
    (A.varray (A.split_r md_bm_region (US.mul md_count_v 4sz))
     `vrefine` zf_u64) `star`
    (A.varray (A.split_r md_bm_region_q (US.mul md_count_v 4sz))
     `vrefine` zf_u64) `star`
    A.varray (A.split_r md_region md_count_v))
    (fun x y -> x == y)
    (fun m -> right_vprop_sl_lemma1 slab_region md_bm_region md_bm_region_q md_region md_count_v m);
  elim_vrefine
    (A.varray (A.split_r slab_region (US.mul md_count_v (u32_to_sz page_size))))
    zf_u8;
  elim_vrefine
  ...
  allocate_slab_aux_3_1_right_aux
    slab_region md_bm_region md_bm_region_q md_region md_count_v;
  change_slprop_rel
    ...
    (A.varray (A.split_r md_bm_region (US.mul (US.add md_count_v guard_pages_interval) 4sz))
     `vrefine` zf_u64) `star`
    (A.varray (A.split_r md_bm_region_q (US.mul (US.add md_count_v guard_pages_interval) 4sz))
     `vrefine` zf_u64) `star`
   A.varray (A.split_r md_region (US.add md_count_v guard_pages_interval)))
    (right_vprop slab_region md_bm_region md_bm_region_q md_region (US.add md_count_v guard_pages_interval))
    (fun x y -> x == y)
    (fun m -> right_vprop_sl_lemma2 slab_region md_bm_region md_bm_region_q md_region (US.add md_count_v guard_pages_interval) m)
...
let allocate_slab_aux_3_1
  ...
  : SteelGhost unit opened
  (
    right_vprop slab_region md_bm_region md_bm_region_q md_region md_count_v `star`
    (AL.varraylist pred1 pred2 pred3 pred4 pred5
      (A.split_l md_region md_count_v)
      (US.v idx1) (US.v idx2) (US.v idx3) (US.v idx4) (US.v idx5) (US.v idx6) (US.v idx7))
  )
...
let lemma_slab_aux_3_3_1
  ...
  (md_region_lv: G.erased (Seq.lseq AL.status (US.v md_count_v)))
  : Lemma
    (let f1 = f size_class slab_region md_bm_region md_bm_region_q md_count_v md_region_lv in
     let f2 = f size_class slab_region md_bm_region md_bm_region_q
  ...
  let md_region_lv' = Seq.append
    ...
    (Seq.append
      ...
      (Seq.create 1 3ul)) in
  let f1 = f size_class slab_region md_bm_region md_bm_region_q md_count_v md_region_lv in
  let f2 = f size_class slab_region md_bm_region md_bm_region_q (US.add md_count_v guard_pages_interval) md_region_lv' in
  let s1 = SeqUtils.init_us_refined (US.v md_count_v) in
  let s2 = Seq.slice (SeqUtils.init_us_refined (US.v (US.add md_count_v guard_pages_interval))) 0 (US.v md_count_v) in
...
let allocate_slab_aux_3_3_1 (#opened:_)
  ...
  (fun _ ->
    starseq
      ...
      #(t size_class)
      (f size_class slab_region md_bm_region md_bm_region_q
        (US.add md_count_v guard_pages_interval)
        (Seq.append md_region_lv (Seq.append
          (Seq.create (US.v guard_pages_interval - 1) 0ul)
          (Seq.create 1 3ul))))
      (f_lemma size_class slab_region md_bm_region md_bm_region_q
        (US.add md_count_v guard_pages_interval)
        (Seq.append md_region_lv (Seq.append
          (Seq.create (US.v guard_pages_interval - 1) 0ul)
          (Seq.create 1 3ul))))
  ...
  =
  lemma_slab_aux_3_3_1 size_class slab_region md_bm_region md_bm_region_q md_region md_count_v md_region_lv;
...
let allocate_slab_aux_3_3_2_1_aux2 (#opened:_)
  ...
  A.ptr_base_offset_inj
    (A.ptr_of (A.split_r (A.split_l
      (A.split_r md_bm_region_q
        ...
        (US.mul i 4sz))
        (US.mul (US.sub i 1sz) 4sz)))
    (A.ptr_of (md_bm_array md_bm_region_q (US.add md_count_v (US.sub i 1sz))));
  change_equal_slprop
    (A.varray (A.split_r (A.split_l
      (A.split_r slab_region
        (US.mul md_count_v (u32_to_sz page_size)))
  ...
  intro_slab_vprop size_class
    ...
    (md_bm_array md_bm_region_q (US.add md_count_v (US.sub i 1sz)))
    (Seq.create 4 0UL);
  ...
  | _ ->
    ...
    let s0 = gget (A.varray (A.split_l
      (A.split_r md_bm_region
        (US.mul md_count_v 4sz))
        (US.mul i 4sz))) in
    let s1 = gget (A.varray (A.split_l
      (A.split_r md_bm_region_q
        (US.mul md_count_v 4sz))
        (US.mul i 4sz))) in
    zf_u64_split s0 (US.v (US.mul (US.sub i 1sz) 4sz));
    zf_u64_split s1 (US.v (US.mul (US.sub i 1sz) 4sz));
    A.ghost_split (A.split_l
      (A.split_r md_bm_region
        (US.mul md_count_v 4sz))
        (US.mul i 4sz))
    ...
    allocate_slab_aux_3_3_2_1_aux size_class
      slab_region md_bm_region md_bm_region_q md_region
      md_count_v md_region_lv
      (US.sub i 1sz);
    //dedicated lemma
  ...
  (
    ...
    A.varray (A.split_l (A.split_l
      (A.split_r md_bm_region
        (US.mul md_count_v 4sz))
        (US.mul guard_pages_interval 4sz))
      (US.mul (US.sub guard_pages_interval 1sz) 4sz)) `star`
    A.varray (A.split_l (A.split_l
      (A.split_r md_bm_region_q
        (US.mul md_count_v 4sz))
        (US.mul guard_pages_interval 4sz))
...
let allocate_slab_aux_3_3_2_2
  ...
  A.ptr_base_offset_inj
    (A.ptr_of (A.split_r (A.split_l
      (A.split_r md_bm_region_q
        ...
        (US.mul guard_pages_interval 4sz))
      (US.mul (US.sub guard_pages_interval 1sz) 4sz)))
    (A.ptr_of (md_bm_array md_bm_region_q (US.add md_count_v (US.sub guard_pages_interval 1sz))));
  change_equal_slprop
    (A.varray (A.split_r (A.split_l
      (A.split_r md_bm_region_q
        (US.mul md_count_v 4sz))
        (US.mul guard_pages_interval 4sz))
      (US.mul (US.sub guard_pages_interval 1sz) 4sz)))
    (A.varray (md_bm_array md_bm_region_q (US.add md_count_v (US.sub guard_pages_interval 1sz))));
  ...
  p_guard_pack size_class
    ...
    (md_bm_array md_bm_region_q (US.add md_count_v (US.sub guard_pages_interval 1sz)));
  SeqUtils.init_us_refined_index
    (US.v (US.add md_count_v guard_pages_interval))
...
let allocate_slab_aux_3_3_2
  ...
  let md_bm_region_q0 = gget (A.varray (A.split_l
      (A.split_r md_bm_region_q
        (US.mul md_count_v 4sz))
        (US.mul guard_pages_interval 4sz))) in
  zf_u64_split md_bm_region_q0 ((US.v guard_pages_interval - 1) * 4);
  A.ghost_split
    (A.split_l
      (A.split_r slab_region
        (US.mul md_count_v (u32_to_sz page_size)))
  ...
  allocate_slab_aux_3_3_2_1 size_class
    slab_region md_bm_region md_bm_region_q md_region md_count_v md_region_lv;
...
let allocate_slab_aux_3
  ...
  (fun _ ->
    vptr md_count `star`
    A.varray r_idxs `star`
    right_vprop slab_region md_bm_region md_bm_region_q md_region (US.add md_count_v guard_pages_interval) `star`
    AL.varraylist pred1 pred2 pred3 pred4 pred5
      (A.split_l md_region (md_count_v `US.add` guard_pages_interval))
      (US.v md_count_v + US.v guard_pages_interval - 2)
      (US.v idx2) (US.v idx3)
...
let allocate_slab_aux_4_aux2
  ...
  (fun _ ->
    starseq
      #(pos:US.t{US.v pos < US.v md_count_v})
      #(t size_class)
      (f size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idxs.x) 0ul))
      (f_lemma size_class slab_region md_bm_region md_bm_region_q md_count_v (Seq.upd (G.reveal md_region_lv) (US.v idxs.x) 0ul))
      (SeqUtils.init_us_refined (US.v md_count_v))
  )
  (requires fun h0 ->
  ...
  (**) change_equal_slprop
    ...
    (p_quarantine size_class
      (slab_array slab_region idxs.x)
      (md_bm_array md_bm_region idxs.x)
      (md_bm_array md_bm_region_q idxs.x));
  p_quarantine_unpack size_class
    (slab_array slab_region idxs.x)
    (md_bm_array md_bm_region idxs.x)
    (md_bm_array md_bm_region_q idxs.x);
...
let allocate_slab'
  ...
  if (idx2 <> AL.null_ptr) then (
    ...
    pack_right_and_refactor_vrefine_dep
      size_class slab_region md_bm_region md_bm_region_q md_region md_count
      r_idxs md_count_v;
    ...
    if enable_quarantine && b then (
      ...
      if b then (
        ...
        pack_3 size_class
          ...
          md_count_v md_region_lv idx1 idx2 idx3 idx4 idx5 idx6 idx7;
        pack_right_and_refactor_vrefine_dep
          size_class slab_region md_bm_region md_bm_region_q md_region
          md_count
          r_idxs md_count_v;
        change_equal_slprop
          emp
...
let allocate_slab
  ...
  let md_count_v
    ...
    = elim_vrefinedep
      (vptr md_count)
      vrefinedep_prop
      (size_class_vprop_aux size_class slab_region md_bm_region md_bm_region_q md_region r_idxs) in

  let md_count_v_ = read md_count in

  change_equal_slprop
    (size_class_vprop_aux size_class slab_region md_bm_region md_bm_region_q md_region r_idxs (G.reveal md_count_v))
    (left_vprop size_class slab_region md_bm_region md_bm_region_q md_region
      r_idxs md_count_v_ `star`
    right_vprop slab_region md_bm_region md_bm_region_q md_region md_count_v_);
  change_equal_slprop
    (left_vprop size_class slab_region md_bm_region md_bm_region_q md_region
      r_idxs md_count_v_)
    (left_vprop1 md_region r_idxs md_count_v_
    `vdep`
    left_vprop2 size_class slab_region md_bm_region md_bm_region_q md_region r_idxs md_count_v_);

  let x
    : G.erased _
    = elim_vdep
    (left_vprop1 md_region r_idxs md_count_v_)
    (left_vprop2 size_class slab_region md_bm_region md_bm_region_q md_region r_idxs md_count_v_) in
  ...
  change_equal_slprop
    (left_vprop2 size_class slab_region md_bm_region md_bm_region_q md_region r_idxs md_count_v_ x)
    (left_vprop2_aux size_class slab_region md_bm_region md_bm_region_q md_count_v_ x');
  change_equal_slprop
    (left_vprop2_aux size_class slab_region md_bm_region md_bm_region_q md_count_v_ x')
    (starseq
      #(pos:US.t{US.v pos < US.v md_count_v_})
      #(t size_class)
      (f size_class slab_region md_bm_region md_bm_region_q md_count_v_ x')
      (f_lemma size_class slab_region md_bm_region md_bm_region_q md_count_v_ x')
