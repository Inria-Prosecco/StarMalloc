...
let remove
  ...
  = AL.remove r hd1 hd2 hd3 hd4 hd5 idx
...
let remove1
  ...
  = remove r hd1 hd2 hd3 hd4 hd5 idx
...
let remove2
  ...
  = AL.permute12 pred1 pred2 pred3 pred4 pred5 r hd1 (US.v hd2) hd3 hd4 hd5;
    let v = remove r hd2 hd1 hd3 hd4 hd5 idx in
    AL.permute12 pred2 pred1 pred3 pred4 pred5 r (US.v v) hd1 hd3 hd4 hd5;
    return v
...
let remove3
  ...
  = AL.permute13 pred1 pred2 pred3 pred4 pred5 r hd1 hd2 (US.v hd3) hd4 hd5;
    let v = remove r hd3 hd2 hd1 hd4 hd5 idx in
...
let insert
  ...
  = AL.insert r hd hd2 hd3 hd4 hd5 idx v
...
let insert1
  ...
  = insert r hd hd2 hd3 hd4 hd5 idx v
...
let insert2
  ...
  = AL.permute12 pred1 pred2 pred3 pred4 pred5 r hd1 (US.v hd) hd3 hd4 hd5;
    insert r hd hd1 hd3 hd4 hd5 idx v;
    AL.permute12 pred2 pred1 pred3 pred4 pred5 r (US.v idx) hd1 hd3 hd4 hd5
...
let insert3
  ...
  = AL.permute13 pred1 pred2 pred3 pred4 pred5 r hd1 hd2 (US.v hd) hd4 hd5;
    insert r hd hd2 hd1 hd4 hd5 idx v;
    AL.permute13 pred3 pred2 pred1 pred4 pred5 r (US.v idx) hd2 hd1 hd4 hd5
...
let insert4
  ...
  =
  AL.permute14 pred1 pred2 pred3 pred4 pred5 r hd1 hd2 hd3 (US.v hd) hd5;
