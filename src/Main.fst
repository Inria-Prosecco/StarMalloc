...
let intro_right_vprop_empty2 slab_region md_bm_region md_region =
  ...
  change_equal_slprop
    (A.varray (A.split_r slab_region 0sz))
    (A.varray (A.split_r slab_region (US.mul 0sz sc_ex_slab_size)));
  intro_vrefine
    (A.varray (A.split_r slab_region (US.mul 0sz sc_ex_slab_size))) zf_u8;
  intro_vrefine
...
let init_struct_aux2
  (sc:sc_ex)
  (slab_region: array U8.t{A.length slab_region == US.v sc_ex_slab_size * US.v metadata_max_ex})
  (md_bm_region: array bool{A.length md_bm_region == US.v metadata_max_ex})
  (md_region: array AL.cell{A.length md_region == US.v metadata_max_ex})
...
let init_struct
  ...
  (requires fun h0 ->
    ...
    US.fits (US.v metadata_max_ex * US.v sc_ex_slab_size) /\
  //  US.v n > 0 /\
  //  US.fits (US.v metadata_max * US.v n) /\
  //  US.fits (US.v metadata_max * US.v 4sz * US.v n) /\
  //  US.fits (US.v metadata_max * US.v (u32_to_sz page_size) * US.v n) /\
...
let init_struct2
  ...
  (fun scs -> size_class_vprop_sc_ex scs `star`
    A.varray (A.split_r slab_region (US.mul metadata_max_ex sc_ex_slab_size)) `star`
  ...
  (requires fun h0 ->
    US.fits (US.v metadata_max) /\
    US.fits (US.v metadata_max * US.v 4sz) /\
    US.fits (US.v metadata_max * U32.v page_size) /\
    US.fits (US.v metadata_max_ex * US.v sc_ex_slab_size) /\
    array_u8_alignment slab_region page_size /\
    zf_u8 (A.asel slab_region h0) /\
    zf_b (A.asel md_bm_region h0)
  ...
  (ensures fun _ r h1 ->
    r.size == Sc_ex sc /\
    array_u8_alignment (A.split_r slab_region (US.mul metadata_max (u32_to_sz page_size))) page_size /\
    zf_u8 (A.asel (A.split_r slab_region (US.mul metadata_max_ex sc_ex_slab_size)) h1) /\
  ...
  let s1 = gget (A.varray slab_region) in
  let s2 = gget (A.varray md_bm_region) in
  zf_u8_split s1 (US.v (US.mul metadata_max_ex sc_ex_slab_size));
  zf_b_split s2 (US.v metadata_max_ex);
  A.ghost_split slab_region (US.mul metadata_max_ex sc_ex_slab_size);
  A.ghost_split md_bm_region metadata_max_ex;
  A.ghost_split md_region metadata_max_ex;
  let slab_region' = A.split_l slab_region (US.mul metadata_max_ex sc_ex_slab_size) in
  let md_bm_region' = A.split_l md_bm_region metadata_max_ex in
  let md_region' = A.split_l md_region metadata_max_ex in
  change_equal_slprop
    (A.varray (A.split_l slab_region (US.mul metadata_max_ex sc_ex_slab_size)))
    (A.varray slab_region');
  change_equal_slprop
  ...
  change_equal_slprop
    ...
    (A.varray md_region');
  assert (A.length slab_region' == US.v metadata_max_ex * US.v sc_ex_slab_size);
  assert (A.length md_bm_region' == US.v metadata_max_ex);
  assert (A.length md_region' == US.v metadata_max_ex);
  assert (US.v (US.mul metadata_max_ex sc_ex_slab_size)
  == US.v metadata_max * U32.v page_size
  );
  lemma_mod_mul2 (US.v metadata_max) (U32.v page_size) 16;
  assert (US.v (US.mul metadata_max (u32_to_sz page_size)) % 16 == 0);
  array_u8_alignment_lemma slab_region slab_region'
    page_size page_size;
  array_u8_alignment_lemma slab_region
    (A.split_r slab_region (US.mul metadata_max_ex sc_ex_slab_size))
    page_size page_size;
  assert (array_u8_alignment slab_region' page_size);
...
let f_lemma2
  (n: US.t{
    US.fits (US.v metadata_max_ex * US.v sc_ex_slab_size * US.v n) /\
    US.fits (US.v metadata_max_ex * US.v n)
  })
  (k: US.t{US.v k <= US.v n})
  : Lemma
  (
    US.fits (US.v metadata_max_ex * US.v sc_ex_slab_size * US.v k) /\
    US.fits (US.v metadata_max_ex * US.v k) /\
    US.v metadata_max_ex * US.v sc_ex_slab_size * US.v k <= US.v metadata_max_ex * US.v sc_ex_slab_size * US.v n /\
    US.v metadata_max_ex * US.v k <= US.v metadata_max_ex * US.v n /\
    US.fits (US.v metadata_max_ex * US.v sc_ex_slab_size) /\
    True
  )
  =
  FML.lemma_mult_le_right (US.v metadata_max_ex * US.v sc_ex_slab_size) (US.v k) (US.v n);
...
val init_wrapper2
  ...
  (k': US.t{US.v k' <= US.v n})
  (slab_region: array U8.t{
    A.length slab_region == US.v metadata_max_ex * US.v sc_ex_slab_size * US.v n /\
    A.length slab_region >= US.v metadata_max_ex * US.v sc_ex_slab_size * US.v k /\
    A.length slab_region >= US.v metadata_max_ex * US.v sc_ex_slab_size * US.v k'
  })
  ...
  : Steel size_class
  (
    A.varray (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) k)) `star`
  ...
  (requires fun h0 ->
    US.v k < US.v n /\
    US.v k' == US.v k + 1 /\
    array_u8_alignment (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) k)) page_size /\
    zf_u8 (A.asel (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) k)) h0) /\
    zf_b (A.asel (A.split_r md_bm_region (US.mul metadata_max_ex k)) h0) /\
    True
  )
  (ensures fun _ r h1 ->
    array_u8_alignment (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) k')) page_size /\
    zf_u8 (A.asel (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) k')) h1) /\
...
let init_wrapper2 sc n k k' slab_region md_bm_region md_region
  ...
  let data = init_struct2 sc
    (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) k))
    (A.split_r md_bm_region (US.mul metadata_max_ex k))
    (A.split_r md_region (US.mul metadata_max_ex k))
  in
  split_r_r_mul
    (US.mul metadata_max_ex sc_ex_slab_size)
    k
    k'
    slab_region;
  split_r_r_mul
...
let synced_sizes offset size_classes sizes k
  : prop
  =
...
let synced_sizes_reveal offset size_classes sizes k = ()
...
val init_size_class
  ...
  (requires fun h0 ->
    ...
    Sc? (TLA.get sizes (US.add offset k)) /\
...
val init_size_class2
  ...
  (requires fun h0 ->
    ...
    US.fits (US.v offset + US.v k) /\
    TLA.length sizes > US.v offset + US.v k /\
    Sc_ex? (TLA.get sizes (US.add offset k)) /\
    synced_sizes offset (asel size_classes h0) sizes (US.v k) /\
    (forall (i:nat{i < US.v k}) . size_class_pred slab_region (Seq.index (asel size_classes h0) i) i) /\
    True
  )
...
val init_size_classes_aux (l:list sc)
  ...
  (requires fun h0 ->
    ...
    synced_sizes offset (asel size_classes h0) sizes (US.v k) /\
    (forall (i:nat{i < US.v k}) . size_class_pred slab_region (Seq.index (asel size_classes h0) i) i) /\
    (forall (i:US.t{US.v k <= US.v i /\ US.v i < US.v n}). Sc? (TLA.get sizes (US.add offset i))) /\
    True
  )
  (ensures fun _ r h1 ->
...
val init_size_classes_aux2 (l:list sc_ex)
  ...
  (fun r ->
    A.varray (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) n)) `star`
  ...
  (requires fun h0 ->
    ...
    synced_sizes offset (asel size_classes h0) sizes (US.v k) /\
    (forall (i:nat{i < US.v k}) . size_class_pred slab_region (Seq.index (asel size_classes h0) i) i) /\
    (forall (i:US.t{US.v k <= US.v i /\ US.v i < US.v n}). Sc_ex? (TLA.get sizes (US.add offset i))) /\
    True
  )
  (ensures fun _ r h1 ->
    array_u8_alignment (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) n)) page_size /\
    zf_u8 (A.asel (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) n)) h1) /\
...
val init_size_classes (l:list sc)
  ...
  (requires fun h0 ->
    ...
    TLA.length sizes >= US.v offset + US.v n /\
    (forall (i:US.t{US.v i < US.v n}). Sc? (TLA.get sizes (US.add offset i))) /\
    //(forall (i:nat{i < US.v k}) . size_class_pred slab_region (Seq.index (asel size_classes h0) i) i) /\
...
val init_size_classes2 (l:list sc_ex)
  ...
  (slab_region: array U8.t{
    A.length slab_region == US.v metadata_max_ex * US.v sc_ex_slab_size * US.v n /\
    A.length slab_region >= US.v metadata_max_ex * US.v sc_ex_slab_size * 0 /\
    A.length slab_region >= US.v metadata_max_ex * US.v sc_ex_slab_size * 1
  })
  (md_bm_region: array bool{
    A.length md_bm_region == US.v metadata_max_ex * US.v n /\
  ...
  : Steel unit
  (
    A.varray (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) 0sz)) `star`
  ...
  (requires fun h0 ->
    ...
    array_u8_alignment (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) 0sz)) page_size /\
    zf_u8 (A.asel (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) 0sz)) h0) /\
    zf_b (A.asel (A.split_r md_bm_region (US.mul metadata_max_ex 0sz)) h0) /\
    TLA.length sizes >= US.v offset + US.v n /\
    (forall (i:US.t{US.v i < US.v n}). Sc_ex? (TLA.get sizes (US.add offset i))) /\
    synced_sizes offset (asel size_classes h0) sizes 0 /\
    True
    //(forall (i:nat{i < US.v k}) . size_class_pred slab_region (Seq.index (asel size_classes h0) i) i)
  )
...
val init_all_size_classes2 (l:list sc_ex)
  ...
  (ensures fun _ r h1 ->
    //array_u8_alignment (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) n)) (u32_to_sz page_size) /\
    //zf_u8 (A.asel (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) n)) h1) /\
    //zf_b (A.asel (A.split_r md_bm_region (US.mul metadata_max_ex n)) h1) /\
    TLA.length sizes >= US.v offset + US.v n /\
    synced_sizes offset (asel size_classes h1) sizes (US.v n) /\
...
let init_all_size_classes2
  ...
  drop (A.varray (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) n)));
...
let init_all_size_classes_wrapper2
  l offset n slab_region md_bm_region md_region size_classes sizes
  =
  Math.Lemmas.mul_zero_right_is_zero (US.v (US.mul metadata_max_ex sc_ex_slab_size));
  ...
  change_equal_slprop
    (A.varray slab_region)
    (A.varray (A.split_r slab_region (US.mul (US.mul metadata_max_ex sc_ex_slab_size) 0sz)));
  change_equal_slprop
    (A.varray md_bm_region)
...
val init_all_size_classes
  ...
  (requires fun h0 ->
    ...
    US.v n1 > 0 /\
    US.v n2 > 0 /\
    array_u8_alignment (A.split_l slab_region (US.mul (US.mul metadata_max (u32_to_sz page_size)) n1)) page_size /\
    array_u8_alignment (A.split_r slab_region (US.mul (US.mul metadata_max (u32_to_sz page_size)) n1)) page_size /\
...
let init_all_size_classes
  ...
  ==
  US.v metadata_max_ex * US.v sc_ex_slab_size * US.v n2);
...
let array_u8_alignment_mod_aux
  (v:U32.t{U32.v v > 0})
  : Lemma
  (0 % U32.v v == 0)
  = ()

let array_u8_alignment_mod
  (arr: array U8.t)
  (pos: US.t)
  (alignment: U32.t{U32.v alignment > 0})
  : Lemma
  (requires
    US.v pos <= A.length arr /\
    US.v pos % U32.v alignment == 0 /\
    array_u8_alignment arr alignment
  )
  (ensures
    array_u8_alignment (A.split_l arr pos) alignment /\
    array_u8_alignment (A.split_r arr pos) alignment
  )
  =
  assert (A.offset (A.ptr_of (A.split_l arr pos)) - A.offset (A.ptr_of arr) == 0);
  array_u8_alignment_mod_aux alignment;
  array_u8_alignment_lemma arr (A.split_l arr pos) alignment alignment;
  assert (A.offset (A.ptr_of (A.split_r arr pos)) - A.offset (A.ptr_of arr) == US.v pos);
  array_u8_alignment_lemma arr (A.split_r arr pos) alignment alignment

#restart-solver

let array_u8_alignment_split_helper_page_size
  (arr: array U8.t)
  (k1 k3: US.t)
  : Lemma
  (requires
    US.v k1 > 0 /\
    US.v k3 > 0 /\
    array_u8_alignment arr page_size /\
    US.fits (US.v k1 * US.v (u32_to_sz page_size)) /\
    US.fits (US.v (US.mul k1 (u32_to_sz page_size)) * US.v k3) /\
    US.v (US.mul (US.mul k1 (u32_to_sz page_size)) k3) <= A.length arr
  )
  (ensures (
    let pos = US.mul (US.mul k1 (u32_to_sz page_size)) k3 in
    let arr1 = A.split_l arr pos in
    let arr2 = A.split_r arr pos in
    array_u8_alignment arr1 page_size /\
    array_u8_alignment arr2 page_size
  ))
  =
  let pos' = US.mul k1 (u32_to_sz page_size) in
  MiscArith.lemma_mod_mul2 (US.v k1) (U32.v page_size) (U32.v page_size);
  assert (US.v pos' % U32.v page_size == 0);
  let pos = US.mul pos' k3 in
  MiscArith.lemma_mod_mul2 (US.v k3) (US.v pos') (U32.v page_size);
  assert (US.v pos % U32.v page_size == 0);
  array_u8_alignment_mod arr pos page_size
...
let init_all_size_classes_wrapper
  ...
  array_u8_alignment_split_helper_page_size slab_region metadata_max n1;
  assert (array_u8_alignment (A.split_l slab_region (US.mul (US.mul metadata_max (u32_to_sz page_size)) n1)) page_size);
  assert (array_u8_alignment (A.split_r slab_region (US.mul (US.mul metadata_max (u32_to_sz page_size)) n1)) page_size);
  let size_classes1_s0 = gget (A.varray (A.split_l size_classes n1)) in
  let size_classes2_s0 = gget (A.varray (A.split_r size_classes n1)) in
  init_all_size_classes
    l1 l2
...
/// to the sizes of a list of size_classes
[@"opaque_to_smt"]
let hidden_pred l1 l2 n n1 n2 s1 s2 s3
  : prop
  =
  US.fits (US.v metadata_max * US.v (u32_to_sz page_size) * US.v n) /\
  US.fits (US.v metadata_max * US.v 4sz * US.v n) /\
...
let hidden_pred_reveal l1 l2 n n1 n2 s1 s2 s3
  = reveal_opaque (`%hidden_pred) hidden_pred

[@"opaque_to_smt"]
let hidden_pred2 n s1
  : prop
  =
  US.v n > 0 /\
  US.v s1 > 0 /\
...
val init_one_arena
  ...
  (ensures fun _ _ h1 ->
    array_u8_alignment (A.split_r slab_region arena_slab_region_size) page_size /\
...
let init_one_arena
  ...
  array_u8_alignment_mod slab_region arena_slab_region_size page_size;
  assert (array_u8_alignment (A.split_l slab_region arena_slab_region_size) page_size);
  assert (array_u8_alignment (A.split_r slab_region arena_slab_region_size) page_size);
  init_one_arena'
    offset
    l1 l2 n1 n2 n
    arena_slab_region_size
...
let init_one_arena2
  ...
  synced_sizes_arena_lemma n offset s sizes 1;
  assert (synced_sizes_arena n offset s sizes 1);
...
val init_nth_arena_aux
  ...
  (requires fun h0 ->
    US.v k' == US.v k + 1 /\
    array_u8_alignment (A.split_r slab_region (US.mul arena_slab_region_size k)) page_size /\
  ...
  (ensures fun _ _ h1 ->
    array_u8_alignment (A.split_r (A.split_r slab_region (US.mul arena_slab_region_size k)) arena_slab_region_size) page_size /\
...
let init_nth_arena
  ...
  sizes
  =
  assert (US.v (US.mul arena_slab_region_size k') - US.v (US.mul arena_slab_region_size k)
  == US.v arena_slab_region_size);
  A.ptr_base_offset_inj
    (A.ptr_of (A.split_r (A.split_r slab_region (US.mul arena_slab_region_size k)) arena_slab_region_size))
    (A.ptr_of (A.split_r slab_region (US.mul arena_slab_region_size k')));
  assert (A.split_r (A.split_r slab_region (US.mul arena_slab_region_size k)) arena_slab_region_size
  == A.split_r slab_region (US.mul arena_slab_region_size k'));
  array_u8_alignment_mod (A.split_r slab_region (US.mul arena_slab_region_size k)) arena_slab_region_size page_size;
  assert (array_u8_alignment (A.split_r slab_region (US.mul arena_slab_region_size k')) page_size);
  init_nth_arena'
    l1 l2 n1 n2 n
    arena_slab_region_size
    arena_md_region_size
...
val init_nth_arena_inv
  ...
  (requires fun h0 ->
    ...
    //A.length size_classes >= US.v n * US.v k /\
    synced_sizes_arena n
      0sz (asel size_classes h0) sizes (US.v k) /\
    size_class_preds_arena n arena_slab_region_size
      (asel size_classes h0) (US.v k) slab_region /\
    True
  )
  (ensures fun _ _ h1 ->
    ...
    TLA.length sizes >= US.v n * US.v k' /\
    synced_sizes_arena n
      0sz (asel size_classes h1) sizes (US.v k') /\
    size_class_preds_arena n arena_slab_region_size
      (asel size_classes h1) (US.v k') slab_region /\
    True
  )
...
let synced_sizes_arena_join_lemma
  ...
  (k:US.t{US.v k < US.v nb_arenas})
  (k':US.t{US.v k <= US.v nb_arenas})
  (size_classes:Seq.seq size_class{Seq.length size_classes == US.v n * US.v nb_arenas})
  (sizes:TLA.t sc_union{TLA.length sizes == US.v n * US.v nb_arenas})
 : Lemma
  (requires (
...
val synced_sizes_arena_join
  ...
  : SteelGhost unit opened
  (
    A.varray (A.split_l size_classes (US.mul n k)) `star`
    A.varray (A.split_r size_classes (US.mul n k))
  )
  (fun _ ->
    A.varray size_classes
...
let synced_sizes_arena_join
  n nb_arenas k k' size_classes sizes _
  =
  let s1 = gget (A.varray (A.split_l size_classes (US.mul n k))) in
  let s2 = gget (A.varray (A.split_r size_classes (US.mul n k))) in
  A.ghost_join
   (A.split_l size_classes (US.mul n k))
   (A.split_r size_classes (US.mul n k))
   ();
  change_equal_slprop
   (A.varray (A.merge
...
let synced_sizes2_le_lemma
  (offset: US.t)
  (s1 s2:Seq.seq size_class)
  (sizes:TLA.t sc_union)
  (k:nat{
    k <= Seq.length s1 /\
    k + US.v offset <= TLA.length sizes
  ...
  (k':nat{k' <= k /\
    k' <= Seq.length s2 /\
    Seq.slice s2 0 k' == Seq.slice s1 0 k'
  })
  : Lemma
...
let synced_sizes_arena_le_lemma
  (n: US.t)
  (offset: US.t)
  (s1 s2:Seq.seq size_class)
  (sizes:TLA.t sc_union)
  (k:nat{
    US.v n * k <= Seq.length s1 /\
    US.v n * (k + US.v offset) <= TLA.length sizes /\
    US.fits (US.v n * (US.v offset + k)) /\
    //US.fits (US.v n * US.v offset)
    True
  ...
  (k':nat{k' <= k /\
    US.v n * k' <= Seq.length s2 /\
    Seq.slice s2 0 (US.v n * k') == Seq.slice s1 0 (US.v n * k')
  })
  : Lemma
  (requires
    synced_sizes_arena n 0sz s1 sizes k)
  (ensures
    synced_sizes_arena n 0sz s2 sizes k')
  =
  reveal_opaque (`%synced_sizes_arena) synced_sizes_arena;
  synced_sizes2_le_lemma 0sz s1 s2 sizes (US.v n * k) (US.v n * k')

let size_class_preds_le_lemma
  (s1 s2:Seq.seq size_class)
  (k:nat{
    k <= Seq.length s1
  })
  ...
  : Lemma
  (requires
    size_class_preds s1 k slab_region /\
    Seq.slice s2 0 k' `Seq.equal` Seq.slice s1 0 k'
  )
  (ensures
...
let size_class_preds_arena_le_lemma
  (n: US.t)
  (arena_slab_region_size: US.t)
  (s1 s2:Seq.seq size_class)
  (k:nat{
  ...
  : Lemma
  (requires
    size_class_preds_arena n arena_slab_region_size s1 k slab_region /\
    Seq.slice s2 0 (US.v n * k') `Seq.equal` Seq.slice s1 0 (US.v n * k')
  )
  (ensures size_class_preds_arena n arena_slab_region_size s2 k' slab_region)
  =
  reveal_opaque (`%size_class_preds_arena) size_class_preds_arena;
  reveal_opaque (`%hidden_pred2) hidden_pred2;
  size_class_preds_le_lemma s1 s2 (US.v n * k) (US.v n * k') slab_region

#push-options "--fuel 0 --ifuel 0 --z3rlimit 500 --query_stats"
let init_nth_arena_inv_lemma1 (#opened:_)
  (n: US.t{US.v n > 0})
  ...
  (ensures fun h0 _ h1 ->
    let s0 = asel size_classes h0 in
    let s01 = asel (A.split_l size_classes (US.mul n k)) h1 in
    let s02 = asel (A.split_r size_classes (US.mul n k)) h1 in
    A.length size_classes >= US.v n * US.v k /\
    TLA.length sizes >= US.v n * US.v k /\
    synced_sizes_arena n 0sz s01 sizes (US.v k) /\
    hidden_pred2 n arena_slab_region_size /\
    size_class_preds_arena n arena_slab_region_size s01 (US.v k) slab_region /\
    s0 `Seq.equal` Seq.append s01 s02
  )
  =
  ...
  assert (Seq.slice s01 0 (US.v (US.mul n k)) `Seq.equal` s01);
  assert (s01 `Seq.equal` Seq.slice s0 0 (US.v (US.mul n k)));
...
let init_nth_arena_inv_lemma2
  ...
  (s1: Seq.seq size_class{
    Seq.length s1 == US.v n * US.v nb_arenas /\
    Seq.length s1 >= US.v n * US.v k /\
    Seq.length s1 >= US.v n * US.v k'
  })
...
let split_r_zero (#opened:_) (#a: Type)
  (ptr: array a)
  (coeff: US.t)
  : SteelGhost unit opened
  (A.varray ptr)
  (fun _ -> A.varray (A.split_r ptr (US.mul coeff 0sz)))
  (requires fun _ -> True)
  (ensures fun h0 r h1 ->
    A.split_r ptr (US.mul coeff 0sz)
    ==
    ptr /\
    A.length (A.split_r ptr (US.mul coeff 0sz))
    ==
    A.length ptr /\
    A.asel (A.split_r ptr (US.mul coeff 0sz)) h1
    `Seq.equal`
    A.asel ptr h0
  )
  =
...
let init_all_arenas_lemma (#opened:_)
  ...
  (ensures fun h0 _ h1 ->
    array_u8_alignment (A.split_r slab_region (US.mul arena_slab_region_size 0sz)) page_size /\
    zf_u8 (A.asel (A.split_r slab_region (US.mul arena_slab_region_size 0sz)) h1) /\
    zf_u64 (A.asel (A.split_r md_bm_region (US.mul arena_md_bm_region_size 0sz)) h1) /\
    zf_b (A.asel (A.split_r md_bm_region_b (US.mul arena_md_bm_region_b_size 0sz)) h1) /\
    True
  )
  =
  let s0 = gget (A.varray slab_region) in
  split_r_zero slab_region arena_slab_region_size;
  assert (array_u8_alignment (A.split_r slab_region (US.mul arena_slab_region_size 0sz)) page_size);
  let s0' = gget (A.varray (A.split_r slab_region (US.mul arena_slab_region_size 0sz))) in
  assert (Seq.equal s0 s0');
  // md_bm_region
  let s1 = gget (A.varray md_bm_region) in
  split_r_zero md_bm_region arena_md_bm_region_size;
  let s1' = gget (A.varray (A.split_r md_bm_region (US.mul arena_md_bm_region_size 0sz))) in
  assert (Seq.equal s1 s1');
  // md_bm_region_b
  let s2 = gget (A.varray md_bm_region_b) in
  split_r_zero md_bm_region_b arena_md_bm_region_b_size;
  let s2' = gget (A.varray (A.split_r md_bm_region_b (US.mul arena_md_bm_region_b_size 0sz))) in
  assert (Seq.equal s2 s2');
  // md_region
  split_r_zero md_region arena_md_region_size
