...
[@@ __steel_reduce__]
let v_stars (#a #b: Type) (#p: vprop)
  (f: a -> (vp:vprop{t_of vp == b}))
  (s: Seq.seq a)
  (h: rmem p{FStar.Tactics.with_tactic selector_tactic (can_be_split p (stars #a #b f s) /\ True)})
  = h (stars #a #b f s)

// TODO: consistent naming: starl_seq -> starseq
