...
typedef uint8_t Prims_list__uint32_t_tags;

typedef struct Prims_list__uint32_t_s
{
  Prims_list__uint32_t_tags tag;
  uint32_t hd;
  Prims_list__uint32_t *tl;
}
Prims_list__uint32_t;

extern Prims_list__uint32_t *Config_sc_list_sc;

extern Prims_list__uint32_t *Config_sc_list_ex;


#define __internal_Config_H_DEFINED
#endif
