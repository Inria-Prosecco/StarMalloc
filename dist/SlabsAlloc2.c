...
)
{
  ...
  if (idx1_ != (size_t)16777217U)
  {
    ...
    uint8_t *r = SlabsCommon2_allocate_slot(size_class, ptr0 + shift_size_t0, ptr + shift_size_t);
  ...
  else
  {
    ...
    else
    {
      ...
      if (b1)
      {
        ...
        uint8_t
        *r = SlabsCommon2_allocate_slot(size_class, ptr0 + shift_size_t0, ptr + shift_size_t);
