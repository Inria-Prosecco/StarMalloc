...
#ifndef __SlabsCommon2_H
#define __SlabsCommon2_H

#include "krmllib.h"

typedef void *SlabsCommon2_pred1;

typedef void *SlabsCommon2_pred2;

typedef void *SlabsCommon2_pred3;

typedef void *SlabsCommon2_pred4;

typedef void *SlabsCommon2_pred5;

uint32_t SlabsCommon2_nb_pages(uint32_t sc);
...
bool SlabsCommon2_is_empty(bool b);

bool SlabsCommon2_is_full(bool b);

uint8_t *SlabsCommon2_allocate_slot(uint32_t size_class, uint8_t *arr, bool *md);

uint8_t *SlabsCommon2_deallocate_slot(uint32_t size_class, uint8_t *arr, bool *md);

typedef void *SlabsCommon2_ind_varraylist_aux_refinement;

typedef void *SlabsCommon2_vrefinedep_prop;


#define __SlabsCommon2_H_DEFINED
#endif
