...
size_t Config_sc_ex_slab_size = (size_t)4096U * (size_t)64U;

bool Config_uu___is_Sc(Config_sc_union projectee)
{
  if (projectee.tag == Config_Sc)
    return true;
  else
    return false;
}
