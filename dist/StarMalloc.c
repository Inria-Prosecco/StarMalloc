...
size_t metadata_max_ex;

size_t slab_size;

size_t sc_slab_region_size;
...
init_size_class(
  ...
  const Config_sc_union *sizes
)
{
  size_t idx = offset + k;
  Config_sc_union size = sizes[idx];
  if (size.tag == Config_Sc)
  {
    ...
    *md_count = (size_t)0U;
    ...
    scs =
      {
        .size = { .tag = Config_Sc, { .case_Sc = size1 } }, .is_extended = false,
...
)
{
  size_t idx = offset + k;
  Config_sc_union size = sizes[idx];
  if (size.tag == Config_Sc_ex)
  {
    uint32_t size1 = size.case_Sc_ex;
    static_assert(UINT32_MAX <= SIZE_MAX);
    uint8_t *slab_region_ = slab_region + SizeClass_metadata_max_ex * SizeClass_slab_size * k;
    bool *md_bm_region_ = md_bm_region + SizeClass_metadata_max_ex * k;
    ArrayList_cell *md_region_ = md_region + SizeClass_metadata_max_ex * k;
    size_t *r_idxs = mmap_array_us_init((size_t)7U);
    init_idxs(r_idxs);
    size_t *md_count = mmap_ptr_us_init();
    *md_count = (size_t)0U;
    ...
    scs =
      {
        .size = { .tag = Config_Sc_ex, { .case_Sc_ex = size1 } }, .is_extended = true,
        .slabs_idxs = r_idxs, .md_count = md_count, .slab_region = slab_region_,
...
void Impl_Trees_Types_init_mmap_md_slabs(Impl_Trees_Types_mmap_md_slabs *ret)
{
  ...
  *md_count = (size_t)0U;
  ...
  scs =
    {
      .size = { .tag = Config_Sc, { .case_Sc = avl_data_size } }, .is_extended = false,
...
sizes[120U] =
  {
    { .tag = Config_Sc, { .case_Sc = 16U } }, { .tag = Config_Sc, { .case_Sc = 32U } },
    { .tag = Config_Sc, { .case_Sc = 64U } }, { .tag = Config_Sc, { .case_Sc = 80U } },
    { .tag = Config_Sc, { .case_Sc = 96U } }, { .tag = Config_Sc, { .case_Sc = 112U } },
    { .tag = Config_Sc, { .case_Sc = 128U } }, { .tag = Config_Sc, { .case_Sc = 160U } },
    { .tag = Config_Sc, { .case_Sc = 192U } }, { .tag = Config_Sc, { .case_Sc = 224U } },
    { .tag = Config_Sc, { .case_Sc = 256U } }, { .tag = Config_Sc, { .case_Sc = 320U } },
    { .tag = Config_Sc, { .case_Sc = 384U } }, { .tag = Config_Sc, { .case_Sc = 448U } },
    { .tag = Config_Sc, { .case_Sc = 512U } }, { .tag = Config_Sc, { .case_Sc = 640U } },
    { .tag = Config_Sc, { .case_Sc = 768U } }, { .tag = Config_Sc, { .case_Sc = 896U } },
    { .tag = Config_Sc, { .case_Sc = 1024U } }, { .tag = Config_Sc, { .case_Sc = 1280U } },
    { .tag = Config_Sc, { .case_Sc = 1536U } }, { .tag = Config_Sc, { .case_Sc = 1792U } },
    { .tag = Config_Sc, { .case_Sc = 2048U } }, { .tag = Config_Sc, { .case_Sc = 2560U } },
    { .tag = Config_Sc, { .case_Sc = 3072U } }, { .tag = Config_Sc, { .case_Sc = 3584U } },
    { .tag = Config_Sc, { .case_Sc = 4096U } }, { .tag = Config_Sc_ex, { .case_Sc_ex = 8192U } },
    { .tag = Config_Sc_ex, { .case_Sc_ex = 16384U } },
    { .tag = Config_Sc_ex, { .case_Sc_ex = 32768U } }, { .tag = Config_Sc, { .case_Sc = 16U } },
    { .tag = Config_Sc, { .case_Sc = 32U } }, { .tag = Config_Sc, { .case_Sc = 64U } },
    { .tag = Config_Sc, { .case_Sc = 80U } }, { .tag = Config_Sc, { .case_Sc = 96U } },
    { .tag = Config_Sc, { .case_Sc = 112U } }, { .tag = Config_Sc, { .case_Sc = 128U } },
    { .tag = Config_Sc, { .case_Sc = 160U } }, { .tag = Config_Sc, { .case_Sc = 192U } },
    { .tag = Config_Sc, { .case_Sc = 224U } }, { .tag = Config_Sc, { .case_Sc = 256U } },
    { .tag = Config_Sc, { .case_Sc = 320U } }, { .tag = Config_Sc, { .case_Sc = 384U } },
    { .tag = Config_Sc, { .case_Sc = 448U } }, { .tag = Config_Sc, { .case_Sc = 512U } },
    { .tag = Config_Sc, { .case_Sc = 640U } }, { .tag = Config_Sc, { .case_Sc = 768U } },
    { .tag = Config_Sc, { .case_Sc = 896U } }, { .tag = Config_Sc, { .case_Sc = 1024U } },
    { .tag = Config_Sc, { .case_Sc = 1280U } }, { .tag = Config_Sc, { .case_Sc = 1536U } },
    { .tag = Config_Sc, { .case_Sc = 1792U } }, { .tag = Config_Sc, { .case_Sc = 2048U } },
    { .tag = Config_Sc, { .case_Sc = 2560U } }, { .tag = Config_Sc, { .case_Sc = 3072U } },
    { .tag = Config_Sc, { .case_Sc = 3584U } }, { .tag = Config_Sc, { .case_Sc = 4096U } },
    { .tag = Config_Sc_ex, { .case_Sc_ex = 8192U } },
    { .tag = Config_Sc_ex, { .case_Sc_ex = 16384U } },
    { .tag = Config_Sc_ex, { .case_Sc_ex = 32768U } }, { .tag = Config_Sc, { .case_Sc = 16U } },
    { .tag = Config_Sc, { .case_Sc = 32U } }, { .tag = Config_Sc, { .case_Sc = 64U } },
    { .tag = Config_Sc, { .case_Sc = 80U } }, { .tag = Config_Sc, { .case_Sc = 96U } },
    ...
    { .tag = Config_Sc_ex, { .case_Sc_ex = 8192U } },
    { .tag = Config_Sc_ex, { .case_Sc_ex = 16384U } },
    { .tag = Config_Sc_ex, { .case_Sc_ex = 32768U } }
  };
...
{
  size_t arena_slab_region_size = sc_slab_region_size * (size_t)30U;
  size_t arena_md_bm_region_size = (size_t)1811939328U;
  size_t arena_md_bm_region_b_size = metadata_max_ex * (size_t)3U;
  size_t arena_md_region_size = (size_t)452984832U + metadata_max_ex * (size_t)3U;
  return
    (
      (tuple4){
...
Main_Meta_size_classes_all Main_Meta_init(void)
{
  ...
  size_class *size_classes = mmap_sc_init((size_t)120U);
  size_t offset_ = (size_t)0U;
  init_size_class(offset_,
    (size_t)0U,
    slab_region + arena_sizes.x * (size_t)0U,
    md_bm_region + arena_sizes.z * (size_t)0U,
    md_region + arena_sizes.y * (size_t)0U,
    size_classes,
    sizes);
  init_size_class(offset_,
    (size_t)1U,
  ...
  init_size_class2(offset_ + (size_t)27U,
    ...
    md_bm_region_b + arena_sizes.w * (size_t)0U,
    md_region + arena_sizes.y * (size_t)0U + (size_t)452984832U,
  ...
  init_size_class2(offset_ + (size_t)27U,
    ...
    size_classes + (size_t)27U,
    sizes);
  size_t offset_0 = (size_t)30U;
  init_size_class(offset_0,
    (size_t)0U,
    slab_region + arena_sizes.x * (size_t)1U,
    md_bm_region + arena_sizes.z * (size_t)1U,
    md_region + arena_sizes.y * (size_t)1U,
    size_classes + (size_t)30U,
    sizes);
  init_size_class(offset_0,
    (size_t)1U,
    slab_region + arena_sizes.x * (size_t)1U,
  ...
  init_size_class2(offset_0 + (size_t)27U,
    ...
    md_bm_region_b + arena_sizes.w * (size_t)1U,
    md_region + arena_sizes.y * (size_t)1U + (size_t)452984832U,
    size_classes + (size_t)30U + (size_t)27U,
    sizes);
  init_size_class2(offset_0 + (size_t)27U,
    (size_t)1U,
    slab_region + arena_sizes.x * (size_t)1U + (size_t)16777216U * (size_t)4096U * (size_t)27U,
  ...
  init_size_class2(offset_0 + (size_t)27U,
    ...
    size_classes + (size_t)30U + (size_t)27U,
    sizes);
  size_t offset_1 = (size_t)60U;
  init_size_class(offset_1,
    (size_t)0U,
    slab_region + arena_sizes.x * (size_t)2U,
    md_bm_region + arena_sizes.z * (size_t)2U,
    md_region + arena_sizes.y * (size_t)2U,
    size_classes + (size_t)60U,
    sizes);
  init_size_class(offset_1,
    (size_t)1U,
    slab_region + arena_sizes.x * (size_t)2U,
  ...
  init_size_class2(offset_1 + (size_t)27U,
    ...
    md_bm_region_b + arena_sizes.w * (size_t)2U,
    md_region + arena_sizes.y * (size_t)2U + (size_t)452984832U,
    size_classes + (size_t)60U + (size_t)27U,
    sizes);
  init_size_class2(offset_1 + (size_t)27U,
    (size_t)1U,
    slab_region + arena_sizes.x * (size_t)2U + (size_t)16777216U * (size_t)4096U * (size_t)27U,
  ...
  init_size_class2(offset_1 + (size_t)27U,
    ...
    size_classes + (size_t)60U + (size_t)27U,
    sizes);
  size_t offset_2 = (size_t)90U;
  init_size_class(offset_2,
    (size_t)0U,
    slab_region + arena_sizes.x * (size_t)3U,
    md_bm_region + arena_sizes.z * (size_t)3U,
    md_region + arena_sizes.y * (size_t)3U,
    size_classes + (size_t)90U,
    sizes);
  init_size_class(offset_2,
    (size_t)1U,
    slab_region + arena_sizes.x * (size_t)3U,
  ...
  init_size_class2(offset_2 + (size_t)27U,
    ...
    md_bm_region_b + arena_sizes.w * (size_t)3U,
    md_region + arena_sizes.y * (size_t)3U + (size_t)452984832U,
    size_classes + (size_t)90U + (size_t)27U,
    sizes);
  init_size_class2(offset_2 + (size_t)27U,
    (size_t)1U,
    slab_region + arena_sizes.x * (size_t)3U + (size_t)16777216U * (size_t)4096U * (size_t)27U,
...
{
  Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)0U];
  uint32_t size;
  if (scrut.tag == Config_Sc)
    size = scrut.case_Sc;
  else if (scrut.tag == Config_Sc_ex)
    size = scrut.case_Sc_ex;
  else
    size = KRML_EABORT(uint32_t, "unreachable (pattern matches are exhaustive in F*)");
  if (bytes <= size - 2U)
  {
    Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id * (size_t)30U + (size_t)0U].lock);
    uint8_t
    *r =
      SizeClass_allocate_size_class(Main_Meta_sc_all.size_classes[arena_id
        * (size_t)30U
        + (size_t)0U].data);
    uint8_t *ptr = r;
    Steel_SpinLock_release(&Main_Meta_sc_all.size_classes[arena_id * (size_t)30U + (size_t)0U].lock);
    uint8_t *ptr0 = ptr;
    if (!(ptr0 == NULL))
    {
  ...
  {
    Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)1U];
    uint32_t size1;
    if (scrut.tag == Config_Sc)
      size1 = scrut.case_Sc;
    else if (scrut.tag == Config_Sc_ex)
      size1 = scrut.case_Sc_ex;
    else
    ...
    {
      Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)2U];
      uint32_t size2;
      if (scrut.tag == Config_Sc)
        size2 = scrut.case_Sc;
      else if (scrut.tag == Config_Sc_ex)
        size2 = scrut.case_Sc_ex;
      else
      ...
      {
        Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)3U];
        uint32_t size3;
        if (scrut.tag == Config_Sc)
          size3 = scrut.case_Sc;
        else if (scrut.tag == Config_Sc_ex)
          size3 = scrut.case_Sc_ex;
        else
        ...
        {
          Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)4U];
          uint32_t size4;
          if (scrut.tag == Config_Sc)
            size4 = scrut.case_Sc;
          else if (scrut.tag == Config_Sc_ex)
            size4 = scrut.case_Sc_ex;
          else
          ...
          {
            Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)5U];
            uint32_t size5;
            if (scrut.tag == Config_Sc)
              size5 = scrut.case_Sc;
            else if (scrut.tag == Config_Sc_ex)
              size5 = scrut.case_Sc_ex;
            else
            ...
            {
              Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)6U];
              uint32_t size6;
              if (scrut.tag == Config_Sc)
                size6 = scrut.case_Sc;
              else if (scrut.tag == Config_Sc_ex)
                size6 = scrut.case_Sc_ex;
              else
              ...
              {
                Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)7U];
                uint32_t size7;
                if (scrut.tag == Config_Sc)
                  size7 = scrut.case_Sc;
                else if (scrut.tag == Config_Sc_ex)
                  size7 = scrut.case_Sc_ex;
                else
                  size7 =
                ...
                {
                  Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)8U];
                  uint32_t size8;
                  if (scrut.tag == Config_Sc)
                    size8 = scrut.case_Sc;
                  else if (scrut.tag == Config_Sc_ex)
                    size8 = scrut.case_Sc_ex;
                  else
                    size8 =
                      KRML_EABORT(uint32_t,
                        "unreachable (pattern matches are exhaustive in F*)");
                  ...
                  {
                    Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)9U];
                    uint32_t size9;
                    if (scrut.tag == Config_Sc)
                      size9 = scrut.case_Sc;
                    else if (scrut.tag == Config_Sc_ex)
                      size9 = scrut.case_Sc_ex;
                    else
                      size9 =
                        KRML_EABORT(uint32_t,
                          "unreachable (pattern matches are exhaustive in F*)");
                    ...
                    {
                      Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)10U];
                      uint32_t size10;
                      if (scrut.tag == Config_Sc)
                        size10 = scrut.case_Sc;
                      else if (scrut.tag == Config_Sc_ex)
                        size10 = scrut.case_Sc_ex;
                      else
                        size10 =
                          KRML_EABORT(uint32_t,
                            "unreachable (pattern matches are exhaustive in F*)");
                      ...
                      {
                        Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)11U];
                        uint32_t size11;
                        if (scrut.tag == Config_Sc)
                          size11 = scrut.case_Sc;
                        else if (scrut.tag == Config_Sc_ex)
                          size11 = scrut.case_Sc_ex;
                        else
                          size11 =
                            KRML_EABORT(uint32_t,
                              "unreachable (pattern matches are exhaustive in F*)");
                        ...
                        {
                          Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)12U];
                          uint32_t size12;
                          if (scrut.tag == Config_Sc)
                            size12 = scrut.case_Sc;
                          else if (scrut.tag == Config_Sc_ex)
                            size12 = scrut.case_Sc_ex;
                          else
                            size12 =
                              KRML_EABORT(uint32_t,
                                "unreachable (pattern matches are exhaustive in F*)");
                          ...
                          {
                            Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)13U];
                            uint32_t size13;
                            if (scrut.tag == Config_Sc)
                              size13 = scrut.case_Sc;
                            else if (scrut.tag == Config_Sc_ex)
                              size13 = scrut.case_Sc_ex;
                            else
                              size13 =
                                KRML_EABORT(uint32_t,
                                  "unreachable (pattern matches are exhaustive in F*)");
                            ...
                            {
                              Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)14U];
                              uint32_t size14;
                              if (scrut.tag == Config_Sc)
                                size14 = scrut.case_Sc;
                              else if (scrut.tag == Config_Sc_ex)
                                size14 = scrut.case_Sc_ex;
                              else
                                size14 =
                                  KRML_EABORT(uint32_t,
                                    "unreachable (pattern matches are exhaustive in F*)");
                              ...
                              {
                                Config_sc_union scrut = sizes[arena_id * (size_t)30U + (size_t)15U];
                                uint32_t size15;
                                if (scrut.tag == Config_Sc)
                                  size15 = scrut.case_Sc;
                                else if (scrut.tag == Config_Sc_ex)
                                  size15 = scrut.case_Sc_ex;
                                else
                                  size15 =
                                    KRML_EABORT(uint32_t,
                                      "unreachable (pattern matches are exhaustive in F*)");
                                ...
                                {
                                  Config_sc_union
                                  scrut = sizes[arena_id * (size_t)30U + (size_t)16U];
                                  uint32_t size16;
                                  if (scrut.tag == Config_Sc)
                                    size16 = scrut.case_Sc;
                                  else if (scrut.tag == Config_Sc_ex)
                                    size16 = scrut.case_Sc_ex;
                                  else
                                    size16 =
                                      KRML_EABORT(uint32_t,
                                        "unreachable (pattern matches are exhaustive in F*)");
                                  ...
                                  {
                                    Config_sc_union
                                    scrut = sizes[arena_id * (size_t)30U + (size_t)17U];
                                    uint32_t size17;
                                    if (scrut.tag == Config_Sc)
                                      size17 = scrut.case_Sc;
                                    else if (scrut.tag == Config_Sc_ex)
                                      size17 = scrut.case_Sc_ex;
                                    else
                                      size17 =
                                        KRML_EABORT(uint32_t,
                                          "unreachable (pattern matches are exhaustive in F*)");
                                    ...
                                    {
                                      Config_sc_union
                                      scrut = sizes[arena_id * (size_t)30U + (size_t)18U];
                                      uint32_t size18;
                                      if (scrut.tag == Config_Sc)
                                        size18 = scrut.case_Sc;
                                      else if (scrut.tag == Config_Sc_ex)
                                        size18 = scrut.case_Sc_ex;
                                      else
                                        size18 =
                                          KRML_EABORT(uint32_t,
                                            "unreachable (pattern matches are exhaustive in F*)");
                                      ...
                                      {
                                        Config_sc_union
                                        scrut = sizes[arena_id * (size_t)30U + (size_t)19U];
                                        uint32_t size19;
                                        if (scrut.tag == Config_Sc)
                                          size19 = scrut.case_Sc;
                                        else if (scrut.tag == Config_Sc_ex)
                                          size19 = scrut.case_Sc_ex;
                                        else
                                          size19 =
                                            KRML_EABORT(uint32_t,
                                              "unreachable (pattern matches are exhaustive in F*)");
                                        ...
                                        {
                                          Config_sc_union
                                          scrut = sizes[arena_id * (size_t)30U + (size_t)20U];
                                          uint32_t size20;
                                          if (scrut.tag == Config_Sc)
                                            size20 = scrut.case_Sc;
                                          else if (scrut.tag == Config_Sc_ex)
                                            size20 = scrut.case_Sc_ex;
                                          else
                                            size20 =
                                              KRML_EABORT(uint32_t,
                                                "unreachable (pattern matches are exhaustive in F*)");
                                          ...
                                          {
                                            Config_sc_union
                                            scrut = sizes[arena_id * (size_t)30U + (size_t)21U];
                                            uint32_t size21;
                                            if (scrut.tag == Config_Sc)
                                              size21 = scrut.case_Sc;
                                            else if (scrut.tag == Config_Sc_ex)
                                              size21 = scrut.case_Sc_ex;
                                            else
                                              size21 =
                                                KRML_EABORT(uint32_t,
                                                  "unreachable (pattern matches are exhaustive in F*)");
                                            ...
                                            {
                                              Config_sc_union
                                              scrut = sizes[arena_id * (size_t)30U + (size_t)22U];
                                              uint32_t size22;
                                              if (scrut.tag == Config_Sc)
                                                size22 = scrut.case_Sc;
                                              else if (scrut.tag == Config_Sc_ex)
                                                size22 = scrut.case_Sc_ex;
                                              else
                                                size22 =
                                                  KRML_EABORT(uint32_t,
                                                    "unreachable (pattern matches are exhaustive in F*)");
                                              ...
                                              {
                                                Config_sc_union
                                                scrut = sizes[arena_id * (size_t)30U + (size_t)23U];
                                                uint32_t size23;
                                                if (scrut.tag == Config_Sc)
                                                  size23 = scrut.case_Sc;
                                                else if (scrut.tag == Config_Sc_ex)
                                                  size23 = scrut.case_Sc_ex;
                                                else
                                                  size23 =
                                                    KRML_EABORT(uint32_t,
                                                      "unreachable (pattern matches are exhaustive in F*)");
                                                ...
                                                else
                                                {
                                                  ...
                                                  uint32_t size24;
                                                  if (scrut.tag == Config_Sc)
                                                    size24 = scrut.case_Sc;
                                                  else if (scrut.tag == Config_Sc_ex)
                                                    size24 = scrut.case_Sc_ex;
                                                  else
                                                    size24 =
                                                      KRML_EABORT(uint32_t,
                                                        "unreachable (pattern matches are exhaustive in F*)");
                                                  ...
                                                  else
                                                  {
                                                    ...
                                                    uint32_t size25;
                                                    if (scrut.tag == Config_Sc)
                                                      size25 = scrut.case_Sc;
                                                    else if (scrut.tag == Config_Sc_ex)
                                                      size25 = scrut.case_Sc_ex;
                                                    else
                                                      size25 =
                                                        KRML_EABORT(uint32_t,
                                                          "unreachable (pattern matches are exhaustive in F*)");
                                                    ...
                                                    else
                                                    {
                                                      ...
                                                      uint32_t size26;
                                                      if (scrut.tag == Config_Sc)
                                                        size26 = scrut.case_Sc;
                                                      else if (scrut.tag == Config_Sc_ex)
                                                        size26 = scrut.case_Sc_ex;
                                                      else
                                                        size26 =
                                                          KRML_EABORT(uint32_t,
                                                            "unreachable (pattern matches are exhaustive in F*)");
                                                      ...
                                                      else
                                                      {
                                                        ...
                                                        uint32_t size27;
                                                        if (scrut.tag == Config_Sc)
                                                          size27 = scrut.case_Sc;
                                                        else if (scrut.tag == Config_Sc_ex)
                                                          size27 = scrut.case_Sc_ex;
                                                        else
                                                          size27 =
                                                            KRML_EABORT(uint32_t,
                                                              "unreachable (pattern matches are exhaustive in F*)");
                                                        ...
                                                        else
                                                        {
                                                          ...
                                                          uint32_t size28;
                                                          if (scrut.tag == Config_Sc)
                                                            size28 = scrut.case_Sc;
                                                          else if (scrut.tag == Config_Sc_ex)
                                                            size28 = scrut.case_Sc_ex;
                                                          else
                                                            size28 =
                                                              KRML_EABORT(uint32_t,
                                                                "unreachable (pattern matches are exhaustive in F*)");
                                                          ...
                                                          else
                                                          {
                                                            ...
                                                            uint32_t size29;
                                                            if (scrut.tag == Config_Sc)
                                                              size29 = scrut.case_Sc;
                                                            else if (scrut.tag == Config_Sc_ex)
                                                              size29 = scrut.case_Sc_ex;
                                                            else
                                                              size29 =
                                                                KRML_EABORT(uint32_t,
                                                                  "unreachable (pattern matches are exhaustive in F*)");
...
static size_t slab_getsize(uint8_t *ptr)
{
  ...
  ptrdiff_t diff = pt0 - pt1;
  size_t diff_sz = (size_t)diff;
  size_t index = diff_sz / sc_slab_region_size;
  Config_sc_union scrut = sizes[index];
  uint32_t size;
  if (scrut.tag == Config_Sc)
    size = scrut.case_Sc;
  else if (scrut.tag == Config_Sc_ex)
  ...
  {
    size_t rem_slot = diff_sz % slab_size;
    if (rem_slot == (size_t)0U)
      return (size_t)(size - 2U);
    else
      return (size_t)0U;
  }
...
{
  size_t threshold_ = (size_t)4096U * (size_t)32U;
  size_t threshold = threshold_ - (size_t)2U;
  if (size <= threshold)
  {
