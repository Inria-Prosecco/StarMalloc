...
)
{
  ...
  size_t *r_in = mmap_ptr_us_init();
  size_t *r_out = mmap_ptr_us_init();
  size_t *r_size = mmap_ptr_us_init();
  size_t *r_ringbuffer = mmap_array_us_init(RingBuffer_max_size);
  ...
  scs =
    {
      ...
      .quarantine_ringbuffer = r_ringbuffer, .quarantine_in = r_in, .quarantine_out = r_out,
  ...
  scs =
    {
      ...
      .md_region = md_region, .quarantine_ringbuffer = r_ringbuffer, .quarantine_in = r_in,
      .quarantine_out = r_out, .quarantine_size = r_size
    };
