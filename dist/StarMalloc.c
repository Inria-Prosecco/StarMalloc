...
static size_t slab_region_size = (size_t)16777216U * (size_t)4096U * (size_t)9U * (size_t)4U;
...
{
  uint8_t *slab_region = mmap_u8_init((size_t)16777216U * (size_t)4096U * (size_t)36U);
  uint64_t *md_bm_region = mmap_u64_init((size_t)16777216U * (size_t)4U * (size_t)36U);
  ArrayList_cell *md_region = mmap_cell_status_init((size_t)16777216U * (size_t)36U);
  size_class *size_classes = mmap_sc_init((size_t)36U);
  uint32_t *sizes = mmap_sizes_init((size_t)36U);
  ...
  init_size_class(128U, (size_t)3U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(256U, (size_t)4U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(512U, (size_t)5U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(1024U, (size_t)6U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(2048U, (size_t)7U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(4096U, (size_t)8U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(16U, (size_t)9U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(32U, (size_t)10U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(64U, (size_t)11U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(128U, (size_t)12U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(256U, (size_t)13U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(512U, (size_t)14U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(1024U, (size_t)15U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(2048U, (size_t)16U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(4096U, (size_t)17U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(16U, (size_t)18U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(32U, (size_t)19U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(64U, (size_t)20U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(128U, (size_t)21U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(256U, (size_t)22U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(512U, (size_t)23U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(1024U, (size_t)24U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(2048U, (size_t)25U, slab_region, md_bm_region, md_region, size_classes, sizes);
  ...
  init_size_class(128U, (size_t)30U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(256U, (size_t)31U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(512U, (size_t)32U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(1024U, (size_t)33U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(2048U, (size_t)34U, slab_region, md_bm_region, md_region, size_classes, sizes);
  init_size_class(4096U, (size_t)35U, slab_region, md_bm_region, md_region, size_classes, sizes);
  return
    (
...
static inline uint64_t log2u64(uint64_t x) {
    return 64 - clz64(x) - 1;
}
  ...
  *r =
    SizeClass_allocate_size_class(Main_Meta_sc_all.size_classes[arena_id
      * (size_t)9U
      + (size_t)idx].data);
  uint8_t *ptr = r;
  Steel_SpinLock_release(&Main_Meta_sc_all.size_classes[arena_id * (size_t)9U + (size_t)idx].lock);
  return ptr;
}

static uint8_t *slab_aligned_alloc(size_t arena_id, uint32_t alignment, uint32_t bytes)
{
  uint32_t size = Main_Meta_sc_all.sizes[arena_id * (size_t)9U + (size_t)0U];
  bool b = 4096U % size == 0U;
  if (b && bytes <= size && alignment <= size)
  {
    Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id * (size_t)9U + (size_t)0U].lock);
    uint8_t
    *r =
      SizeClass_allocate_size_class(Main_Meta_sc_all.size_classes[arena_id
        * (size_t)9U
        + (size_t)0U].data);
    uint8_t *ptr = r;
    Steel_SpinLock_release(&Main_Meta_sc_all.size_classes[arena_id * (size_t)9U + (size_t)0U].lock);
    uint8_t *r0 = ptr;
    return r0;
  }
  else
  {
    uint32_t size1 = Main_Meta_sc_all.sizes[arena_id * (size_t)9U + (size_t)1U];
    bool b1 = 4096U % size1 == 0U;
    if (b1 && bytes <= size1 && alignment <= size1)
    {
      Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id * (size_t)9U + (size_t)1U].lock);
      uint8_t
      *r =
        SizeClass_allocate_size_class(Main_Meta_sc_all.size_classes[arena_id
          * (size_t)9U
          + (size_t)1U].data);
      uint8_t *ptr = r;
      Steel_SpinLock_release(&Main_Meta_sc_all.size_classes[arena_id * (size_t)9U + (size_t)1U].lock);
      uint8_t *r0 = ptr;
      return r0;
    }
    else
    {
      uint32_t size2 = Main_Meta_sc_all.sizes[arena_id * (size_t)9U + (size_t)2U];
      bool b2 = 4096U % size2 == 0U;
      if (b2 && bytes <= size2 && alignment <= size2)
      {
      ...
      {
        uint32_t size3 = Main_Meta_sc_all.sizes[arena_id * (size_t)9U + (size_t)3U];
        bool b3 = 4096U % size3 == 0U;
        if (b3 && bytes <= size3 && alignment <= size3)
        {
          Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
            * (size_t)9U
            + (size_t)3U].lock);
        ...
        {
          uint32_t size4 = Main_Meta_sc_all.sizes[arena_id * (size_t)9U + (size_t)4U];
          bool b4 = 4096U % size4 == 0U;
          if (b4 && bytes <= size4 && alignment <= size4)
          {
            Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
              * (size_t)9U
              + (size_t)4U].lock);
          ...
          {
            uint32_t size5 = Main_Meta_sc_all.sizes[arena_id * (size_t)9U + (size_t)5U];
            bool b5 = 4096U % size5 == 0U;
            if (b5 && bytes <= size5 && alignment <= size5)
            {
              Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                * (size_t)9U
                + (size_t)5U].lock);
            ...
            {
              uint32_t size6 = Main_Meta_sc_all.sizes[arena_id * (size_t)9U + (size_t)6U];
              bool b6 = 4096U % size6 == 0U;
              if (b6 && bytes <= size6 && alignment <= size6)
              {
                Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                  * (size_t)9U
                  + (size_t)6U].lock);
              ...
              {
                uint32_t size7 = Main_Meta_sc_all.sizes[arena_id * (size_t)9U + (size_t)7U];
                bool b7 = 4096U % size7 == 0U;
                if (b7 && bytes <= size7 && alignment <= size7)
                {
                  Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                    * (size_t)9U
                    + (size_t)7U].lock);
                ...
                {
                  uint32_t size8 = Main_Meta_sc_all.sizes[arena_id * (size_t)9U + (size_t)8U];
                  bool b8 = 4096U % size8 == 0U;
                  if (b8 && bytes <= size8 && alignment <= size8)
                  {
                    Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                      * (size_t)9U
                      + (size_t)8U].lock);
...
static bool slab_free(uint8_t *ptr)
{
  ...
  else
  {
    ...
    bool
    res = SizeClass_deallocate_size_class(Main_Meta_sc_all.size_classes[index].data, ptr, rem_slab);
