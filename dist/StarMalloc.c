...
{
  uint32_t size = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)0U)];
  if (bytes <= size - 2U)
  {
  ...
  {
    uint32_t size1 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)1U)];
    if (bytes <= size1 - 2U)
    {
    ...
    {
      uint32_t size2 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)2U)];
      if (bytes <= size2 - 2U)
      {
        Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
          * (size_t)27U
      ...
      {
        uint32_t size3 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)3U)];
        if (bytes <= size3 - 2U)
        {
          Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
            * (size_t)27U
        ...
        {
          uint32_t size4 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)4U)];
          if (bytes <= size4 - 2U)
          {
            Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
              * (size_t)27U
          ...
          {
            uint32_t size5 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)5U)];
            if (bytes <= size5 - 2U)
            {
              Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                * (size_t)27U
            ...
            {
              uint32_t size6 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)6U)];
              if (bytes <= size6 - 2U)
              {
                Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                  * (size_t)27U
              ...
              {
                uint32_t size7 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)7U)];
                if (bytes <= size7 - 2U)
                {
                  Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                    * (size_t)27U
                ...
                {
                  uint32_t size8 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)8U)];
                  if (bytes <= size8 - 2U)
                  {
                    Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                      * (size_t)27U
                  ...
                  {
                    uint32_t size9 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)9U)];
                    if (bytes <= size9 - 2U)
                    {
                      Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                        * (size_t)27U
                    ...
                    {
                      uint32_t size10 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)10U)];
                      if (bytes <= size10 - 2U)
                      {
                        Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                          * (size_t)27U
                      ...
                      {
                        uint32_t size11 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)11U)];
                        if (bytes <= size11 - 2U)
                        {
                          Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                            * (size_t)27U
                        ...
                        {
                          uint32_t size12 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)12U)];
                          if (bytes <= size12 - 2U)
                          {
                            Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                              * (size_t)27U
                          ...
                          {
                            uint32_t
                            size13 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)13U)];
                            if (bytes <= size13 - 2U)
                            {
                              Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                                * (size_t)27U
                            ...
                            {
                              uint32_t
                              size14 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)14U)];
                              if (bytes <= size14 - 2U)
                              {
                                Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                                  * (size_t)27U
                              ...
                              {
                                uint32_t
                                size15 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)15U)];
                                if (bytes <= size15 - 2U)
                                {
                                  Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                                    * (size_t)27U
                                ...
                                {
                                  uint32_t
                                  size16 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)16U)];
                                  if (bytes <= size16 - 2U)
                                  {
                                    Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                                      * (size_t)27U
                                  ...
                                  {
                                    uint32_t
                                    size17 = sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)17U)];
                                    if (bytes <= size17 - 2U)
                                    {
                                      Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                                        * (size_t)27U
                                    ...
                                    else
                                    {
                                      uint32_t
                                      size18 =
                                        sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)18U)];
                                      if (bytes <= size18 - 2U)
                                      {
                                        Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                                          * (size_t)27U
                                      ...
                                      else
                                      {
                                        uint32_t
                                        size19 =
                                          sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)19U)];
                                        if (bytes <= size19 - 2U)
                                        {
                                          Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                                            * (size_t)27U
                                        ...
                                        else
                                        {
                                          uint32_t
                                          size20 =
                                            sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)20U)];
                                          if (bytes <= size20 - 2U)
                                          {
                                            Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                                              * (size_t)27U
                                          ...
                                          else
                                          {
                                            uint32_t
                                            size21 =
                                              sizes[(uint32_t)(arena_id * (size_t)27U + (size_t)21U)];
                                            if (bytes <= size21 - 2U)
                                            {
                                              Steel_SpinLock_acquire(&Main_Meta_sc_all.size_classes[arena_id
                                                * (size_t)27U
