...
patch:
	...
	sed -i 's/FStar_SizeT_uint_to_t(FStar_UInt32_v(Utils2_metadata_max + (uint32_t)1U))/524289/g' dist/Slabs.c
	sed -i 's/FStar_SizeT_uint_to_t(FStar_UInt32_v(Utils2_metadata_max + (uint32_t)1U))/524289/g' dist/ArrayList.c
	sed -i 's/FStar_SizeT_uint_to_t(FStar_UInt32_v(Utils2_metadata_max + (uint32_t)1U))/524289/g' dist/StarMalloc.c
